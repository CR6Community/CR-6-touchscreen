...
### ADVICE: You must have prepared a micro-SD card per the [the detailed SD card formatting instructions](Detailed%20SD%20Card%20Formatting%20Instructions.MD), to host the DWIN_SET folder
...
If you did follow the README instructions carefully and you still could not flash the files properly, try a different SD card and double check that you follow precisely [the detailed SD card formatting instructions](Detailed%20SD%20Card%20Formatting%20Instructions.MD)
...
- Access the SD card slot on the back of the display
- Insert an SD card containing the DWIN_SET files to be flashed
- Power ON the printer
- Wait for  END! to display
- Power OFF the printer
- Remove the SD card
- If not finished, copy the next DWIN_SET folder/files to a blank SD card and repeat the above steps, starting with "Power OFF the printer"
- If finished, Power ON the printer
- Verify (per the Examples below) that the flash has been successful

If the motherboard was also flashed correctly before starting this process, then after restarting the printer the Re-Factored Version 1.1 Splash Screen will display, followed by the Main Menu screen, as shown in the Examples below.
...
![Alt text](Sample%20Screen%20Images/Empty%20DWIN_SET%20Flash.jpg)
...
![Alt text](Sample%20Screen%20Images/flash_successful%20-%20CFG%20Only.jpg)
...
![Alt text](Sample%20Screen%20Images/flash_successful%20-%20HZK%20Only.JPG)
...
![Alt text](Sample%20Screen%20Images/flash_failed%20-%20ALL%20ZEROES.jpg%0D) 
